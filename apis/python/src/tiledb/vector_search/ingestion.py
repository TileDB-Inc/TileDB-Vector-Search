    ...
    **kwargs,
    ...
    def ingest_vamana(
        ...
        data = vspy.FeatureVectorArray(
            ctx, parts_array_uri, ids_array_uri, 0, index_timestamp if index_timestamp else 0
        )
        index.train(data)
        index.add(data)
        ...
        index.write_index(ctx, index_group_uri, index_timestamp, storage_version, overwrite_metadata_list)
