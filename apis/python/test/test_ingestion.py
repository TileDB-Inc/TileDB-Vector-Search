...
def test_ivf_flat_ingestion_with_copy_centroids_uri(tmp_path):
    dataset_dir = os.path.join(tmp_path, "dataset")
...
def test_ivf_flat_ingestion_f32_with_training_source_uri(tmp_path):
    dataset_dir = os.path.join(tmp_path, "dataset")
...
def test_ivf_flat_ingestion_tdb_with_training_source_uri(tmp_path):
    ################################################################################################
...
def test_ivf_flat_ingestion_numpy_with_training_source_uri(tmp_path):
    ################################################################################################
    # First set up the data.
    ################################################################################################
    data = np.array([
