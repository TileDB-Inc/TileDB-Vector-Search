...
#     # Create three vectors, each with two dimensions.
#     a = np.array([[1, 1], [2, 2], [3, 3], [4, 4]], dtype=np.float32)
#     assert a.ndim == 2
#     assert a.shape == (4,2)
#     b = vspy.FeatureVectorArray(a)
#     assert b.dimensions() == 2
#     assert b.num_vectors() == 4
#     assert b.feature_type_string() == "float32"
#     c = np.array(b)
#     assert c.ndim == 2
#     assert c.shape == (4,2)
...
# def test_numpy_to_feature_vector_array_one_vector():
#     print('\ntest_numpy_to_feature_vector_array_one_vector ------------')
#     # Create four vectors, each with one dimension.
#     a = np.array([[1, 2, 3, 4]], dtype=np.float32)
#     assert a.ndim == 2
#     assert a.shape == (1,4)
