...
* An array containing ground truth vectors (`--groundtruth_uri`), and/or
...
input array of (unpartitioned) vectors is given by `--db_uri`.  In addition,
...
These arrays all store the `db_uri` and `parts_uri` arrays as `uint8_t`.  The arrays are 
